...
class Landing extends Component {
    ...
    handleDataEntry = (() => {
        ...
        if(!this.state.given_name){
            ...
            document.getElementById('DOBErr').innerHTML = 'Birth date is required';
        }
            ...
            document.getElementById('line1Err').innerHTML = 'Line1 is required';
        }
        else if(!this.state.apt){
            document.getElementById('aptErr').innerHTML = 'Apt number is required';
        }
        else if(!this.state.city){
            document.getElementById('cityErr').innerHTML = 'City is required';
        }
        else if(!this.state.st){
            document.getElementById('stateErr').innerHTML = 'State is required';
        }
        else if(!this.state.country){
            document.getElementById('countryErr').innerHTML = 'Country is required';
        }
        else if(!this.state.zip){
            document.getElementById('zipErr').innerHTML = 'Zipcode is required';
        }
        else if(!this.state.citizen_country){
            document.getElementById('countryCitizenErr').innerHTML = 'Citizen country is required';}
        else if(!this.state.phone){
            document.getElementById('phoneErr').innerHTML = 'Ph is required';
        }
            else {
            let payload = {
    ...
    render() {
        ...
        return (
            <div className="page-content">
                ...
                <h1 className="page-title"> New User Form
                                ...
                                <div className="portlet-body form">
                                    ...
                                    <form action="#" className="horizontal-form">
                                        <div className="form-body">
                                            <h3 className="form-section">Person Info</h3>
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        ...
                                                        ></input>
                                                        <span className=".text-danger" id="givenNameErr"/>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="form-actions right">
                                            ...
                                            <button className="btn blue" onClick={(()=>this.handleDataEntry())}>
