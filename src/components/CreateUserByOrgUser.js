            ...
            <div>
                    ...
                    <div className="top-menu">
                        <ul className="nav navbar-nav pull-right">
                            ...
                            <li className="dropdown dropdown-user">
                                <a href="javascript:;" className="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" className="img-circle" src="/user-authentication-blockchain-ui/src/assets/layouts/layout2/img/avatar3_small.jpg" />
                ...
                <div className="portlet box blue">
                    <div className="portlet-title">
                        <div className="caption">
                            <i className="fa fa-gift"></i>Create New User</div>
                ...
                <div className="form-body">
                    ...
                    <div className="row">
                        ...
                        <button type="button" onClick={()=>{this.handleDataEntry()}}>Submit</button>
                    </div>
                </div>
                </div></div>
        );
